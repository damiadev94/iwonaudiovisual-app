...
export function UpcomingHero({ course }: { course: Course }) {
  ...
  return (
    <div className="relative rounded-2xl overflow-hidden border border-gold/20 bg-gradient-to-br from-iwon-bg via-black to-iwon-bg-secondary">
      ...
      <div className="relative flex flex-col md:flex-row gap-6 md:gap-10 p-6 md:p-10">
        ...
        <div className="flex flex-col justify-center gap-4 min-w-0">
          ...
          <div>
            <h2 className="text-2xl md:text-3xl font-bold leading-tight">{course.title}</h2>
            {course.description && (
