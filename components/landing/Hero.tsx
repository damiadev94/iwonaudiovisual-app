    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-20">
        ...
        <h1 className="leading-none mb-6 uppercase">
          <span className="block text-xl sm:text-2xl md:text-3xl font-light tracking-[0.22em] text-white/40 mb-1">
            filmamos
          </span>
          <span className="block text-6xl sm:text-7xl md:text-8xl lg:text-9xl font-black tracking-tighter text-white leading-none">
            TU VIDEOCLIP
          </span>
          <span className="block text-xl sm:text-2xl md:text-3xl font-light tracking-[0.18em] text-white/40 my-1">
            con cámara
          </span>
